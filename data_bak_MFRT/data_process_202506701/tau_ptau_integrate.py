...
if __name__ == '__main__':
    ...
    ##data
    path_work = "/home/darkgaia/workroom/"
    ...
    for swit in np.arange(3):
        filename = "/home/darkgaia/workroom/0prog/gadget/Gadget-2.0.7/galaxy_general%s/snaps/aa/orbit_%d_directintegration_endless.txt" % (scripts[-1], ID)
        # filename = "/home/darkgaia/workroom/0prog/gadget/Gadget-2.0.7/galaxy_general/snaps/aa/orbit_%d_directintegration_tau%d.txt" % (ID, swit)
        data = np.loadtxt(filename, dtype=float)
    ...
    for level_mass in np.arange(length_model):
        filename = "/home/darkgaia/workroom/0prog/gadget/Gadget-2.0.7/galaxy_general%s/snaps/aa/orbit_%d_directintegration_endless.txt" % (scripts[level_mass], ID)
