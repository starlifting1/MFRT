...
#() 1000000000 particles, server 12 h
# N_particles=10000
# N_particles=20000
N_particles=40000
# N_particles=100000
...
# # cd generate_gadget2_IC/; make; cd ../; 
# make; 
# ./out.exe ${file_snapshot_fractal} ${N_particles} 137. 50. 1 1 0 0. 0. 0. 8. 6. 1.

# #: big noise but all are less diffu
# # make; 
# ./out.exe ${file_snapshot_fractal} ${N_particles} 137. 50. 1 1 ${N_iter} 0. 0. 0. 8. 6. 1.

#: read pos sample from file
#() the statistic data Diffu_ref in the old version stored data (not this version) need to have a 3. ratio to be fixed
file_snapshot_fractal=snapshot_read
make; 
./out.exe ${file_snapshot_fractal} ${N_particles} 137. 50. 1 1 0 0. 0. 0. 8. 6. 1.
...
# # file_snapshot_like_a_galaxy=galaxy_general_NFW_1e5 #no such original DICE IC
# file_snapshot_like_a_galaxy=galaxy_general_NFW_1e6
# # N_particles=10000
# # N_particles=100000
# N_particles=1000000
# # file_snapshot_like_a_galaxy=galaxy_general_NFW_${N_particles}
...
# cd ${folder_diffu_pos}
# make; ./out.exe ${file_snapshot_select} ${N_particles} 137. 50. 0 1 0 0. 0. 0. 198.93 181.95 161.08



# # 3. Using uniform or noised galaxy, on velocity space
# file_snapshot_fractal=snapshot_for_

# # #() 1000000 particles, PC 500 sec
# # N_particles=10000
# # N_particles=30000
# N_particles=100000
# # N_particles=300000
...
# # cd generate_gadget2_IC/; make; cd ../; 
# make; 
# ./out_vel.exe ${file_snapshot_fractal} ${N_particles} 137. 50. 1 1 ${N_iter} 0. 0. 0. 8. 6. 1.
